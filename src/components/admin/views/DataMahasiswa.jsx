...
export function DataMahasiswa({ users, isLoading, handleDeleteUser }) {
  ...
  // Filter data mahasiswa berdasarkan input pencarian (nama atau NIM)
    ...
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
      <div className="p-6 border-b flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Kelola dan lihat semua data mahasiswa yang terdaftar.</p>
        </div>
