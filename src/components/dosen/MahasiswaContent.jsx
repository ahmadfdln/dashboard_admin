...
const MahasiswaContent = ({ mataKuliahList, usersList }) => {
  ...
  const getEnrolledStudents = () => {
    if (
      ...
      console.log("Selected MK:", selectedMataKuliah);
      console.log(
        "Mahasiswa Terdaftar:",
        selectedMataKuliah?.mahasiswaTerdaftar
      );
  ...
  const renderStudentCard = (student, index) => (
    <div
      ...
      className="group bg-white hover:bg-gray-50 border border-gray-200 hover:border-blue-200 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
    >
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="text-left py-4 px-6 font-semibold text-gray-900 hidden sm:table-cell">
                        NIM
                      </th>
          ...
          {selectedMataKuliah ? (
            ...
            <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 py-20">
              <div className="text-center max-w-md mx-auto px-6">
                ...
                <p className="text-gray-500 mb-6">
                  Pilih mata kuliah dari daftar di sebelah kiri untuk melihat
